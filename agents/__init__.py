...
#from .literature_agent1   import LiteratureAgent, LiteratureState
#from .literature_agent2   import LiteratureAgent, PaperState, PaperMetadata
from .literature_agent3   import LiteratureAgent, PaperState, PaperMetadata
