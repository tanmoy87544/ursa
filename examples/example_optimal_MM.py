...
def main(mode: str):
    ...
    try:
        # 1. problem statement
        workspace = "optimal_matrix_multiplication"
        problem = (
            "Implement a python-language matrix multiplication algorithm and program that is "
            "parameterized so that it will be cache optimial for this architecture this "
            "agent is currently running on.  Run the appropriate analysis and experimentation "
            "to prove its optimality.  Provide justification, text, and any associated plots.  "
            "You need to identify what kind of computer you are running on - do not assume anything.  "
