...
problem_string = '''
Search for and find a recent paper by Lawrence, Murph, and Vander Wiel about advancements
in Dempster Shafer inference. I think the name is something like "A New Method For Multinomial 
Inference Using Dempster-Shafer Theory"
