...
class Memory:
    ...
    def retrieve(self, key: str) -> Any:
        ...
        self.episodic.append(
            {"action": "retrieve", "key": key, "timestamp": time.time()}
        )
    ...
    def persist(self, key: str) -> bool:
        ...
        if key in self.short_term:
            ...
            # Add to episodic memory
            self.episodic.append(
                {"action": "persist", "key": key, "timestamp": time.time()}
            )
    ...
    def forget(self, key: str) -> bool:
        ...
        if key in self.short_term:
            ...
            # Add to episodic memory
            self.episodic.append(
                {"action": "forget", "key": key, "timestamp": time.time()}
            )
    ...
    def clear_short_term(self) -> None:
        ...
        # Add to episodic memory
        self.episodic.append(
            {"action": "clear_short_term", "timestamp": time.time()}
        )
    ...
    def _save_memory(self) -> None:
        ...
        try:
            ...
            os.makedirs(
                os.path.dirname(os.path.abspath(self.memory_file)),
                exist_ok=True,
            )

            with open(self.memory_file, "w") as f:
                json.dump(
                    memory_data, f, default=self._json_serializable, indent=2
                )
